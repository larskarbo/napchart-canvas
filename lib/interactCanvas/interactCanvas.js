...
module.exports = function (Napchart) {
  ...
  function down (e, chart) {
    ...
    console.log('down', position, getCoordinates(position, chart))
  ...
  function getCoordinates (position, chart) {
    ...
    return {
      x: (position.x - boundingRect.left) * window.devicePixelRatio,
      y: (position.y - boundingRect.top) * window.devicePixelRatio
    }
  }

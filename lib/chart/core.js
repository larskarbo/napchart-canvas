...
module.exports = function (Napchart) {
  ...
  function draw(chart) {
    ...
    function yeahBoy(){
      if(!chart.calculatedShape
        || chart.calculatedShape !== chart.data.shapes.activeShape){
        // wow shape has changed, we need to recalibrate!
        Napchart.shape.calculateShape(chart)
    ...
    window.requestAnimationFrame(yeahBoy)
  }
